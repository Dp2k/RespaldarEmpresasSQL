        ...
        private void button1_Click(object sender, EventArgs e){
            ...
            if (xlApp != null){
                if (Directory.Exists(textBox3.Text)){
                    ...
                    SqlConnection cnn;
                    string connetionString = (checkBox1.CheckState != CheckState.Checked) ? "Data Source=" + comboBox1.Text + ";User ID=" + textBox1.Text + ";Password=" + textBox2.Text : "Data Source=" + comboBox1.Text + "; Integrated Security=True";
